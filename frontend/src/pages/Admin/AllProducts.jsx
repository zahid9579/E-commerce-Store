...
const AllProducts = () => {
  ...
  return <div className='container mx-[9rem]'>
    <div className='flex flex-col md:flex-row'>
        <div className='p-3'>
            <div className='ml-[2rem] text-xl font-black h-12'>
                        ...
                        <div className='flex'>
                            ...
                            <div className='p-4 flex flex-col justify-around'>
                                <div className='flex justify-between'>
                                    ...
                                    <p className="p text-gray-400 text-sm">
                                        {moment(product.createAt).format("MMMM Do YYYY")}
                                    </p>
                                </div>

                                <p className="text-gray-400 xl:x-[30rem] md:w-[20rem] sm:w-[10rem]
                                text-sm mb-4">{product?.description?.substring(0,160)}...</p>
