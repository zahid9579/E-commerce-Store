...
const ProductCard = ({p}) => {
  ...
  return <div className='max-w-sm relative bg-[#1A1A1A] rounded-lg shadow dark:bg-gray-800 dark:border-gray-700'>
    <section className='relative'>
        ...
        <img className="cursor-pointer" src={p.image} alt={p.name} style={{height:'170px', objectFit: "cover" }}/>
    ...
    <div className='p-5'>
      <div className='flex justify-between'>
        ...
        <p className="text-pink-500 font-semibold">{p?.price?.toLocaleString('en-US', {
          style: 'currency',
          currency: 'USD'
        })}</p>
      </div>
      ...
      <section className='flex justify-between items-center'>
        ...
        <button className='p-2 rounded-lg text-white cursor-pointer' onClick={() => addToCartHandler(p, 1)}>
