        ...
        {activeTab === 1 && (
            <div className="mt-4">
                {userInfo ? (
                    ...
                    <p>Please <span className='hover:underline text-blue-500'><Link to='/login'>sign in </Link> </span>to write a review </p>
                )}
            </div>
        )}
    </section>
        ...
        {activeTab == 2 && (
            ...
            <div>
                {product.reviews.map((review) => (
                    <div key={review._id} className='p-4 rounded-lg xl:ml-[2rem] sm:ml-[0rem]
